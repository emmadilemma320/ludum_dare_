...
var UPGRADE_DEFS := [
	...
	{ "id": "upgrade_b", "icon": "res://Homebase/Speed.png", "label": "Shiny Gear (Spd+)", "price": 70 },
	{ "id": "upgrade_c", "icon": "res://Homebase/Dive.png", "label": "Kama’s Arrowhead (Dive+)", "price": 80 },
	{ "id": "upgrade_d", "icon": "res://Homebase/Flap.png", "label": "Ra's Feather (Flap+)", "price": 80 },
	{ "id": "upgrade_e", "icon": "res://Homebase/Hover.png", "label": "Golden Umberlla (Hover+)", "price": 80 },
	{ "id": "upgrade_f", "icon": "res://Homebase/capacity.png", "label": "Pandora's Box (Inventory+)", "price": 90 },
